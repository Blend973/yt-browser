...
- **Terminal Previews**: Get video thumbnail previews directly in compatible terminals (e.g., Kitty, using Chafa).           - **Flexible Playback**: Play videos (or just the audio) in your preferred player like `mpv` or `vlc`.                        
...
- **For Image Previews**:
    ...
    - `chafa` (recommended for most terminals)                                                                                    - `kitty-icat` (if you use Kitty terminal)                                                                                    - `imgcat` (for iTerm2 users)                                                                                                 
- **Alternative Menus**:
                                                                                                                                  - `rofi`                                                                                                                  
    - `gum`                                                                                                                       
### Installation of Dependencies                                                                                                  
<details>                                                                                                                         <summary><b>On Debian / Ubuntu</b></summary>                                                                                  
```bash
sudo apt update                                                                                                               
